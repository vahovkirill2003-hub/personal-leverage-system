...
## Data Model and Persistence Specification v0.2

**Статус:** кандидат на пользовательскую приёмку; после приёмки заменяет `14-data-model-persistence-spec-v0.1.md` в части двух редакционных правок — строка `case` в §3.1 (`PLS-031`) и строка `evidence_retention_policy` в §3.6 (закрытие errata `PAV-2` аудита `24`). В остальном идентична v0.1; v0.1 сохраняется как принятое основание и не редактируется. Продуктовая семантика не изменена: обе правки приводят текст в соответствие уже принятым решениям.  
**Дата:** 13 августа 2026  
**Основание:** архитектурный baseline `11-technical-architecture-v1.1.md` (168448 байт, `faf6e5…30c22`), акт `13-architecture-baseline-acceptance-v0.md` (8073 байта, `0d9454…79aa`), продуктовый baseline v2 и решения `PLS-001–PLS-066`; errata `PAV-2` отчёта `24-independent-package-audit-v0.md` §2, принятая Кириллом (`24` §5 п. 1)  
